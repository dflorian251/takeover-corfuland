      ...
      <div class="container-fluid page-body-wrapper">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../events/admin_post_event.html">Event Posting</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../events/admin_delete_event.html">Event Deleting</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../events/admin_approve_event.html">Event Approving</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="categories">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="admin_add_category.html">Add Category</a></li>
                  <li class="nav-item"> <a class="nav-link" href="admin_delete_category.html">Delete Category</a></li>
                </ul>
              </div>
            </li>
            <!-- ADS -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form class="nice-form-group" action="../../admin_operations/delete_category.php" method="post">
