      ...
      <div class="container-fluid page-body-wrapper">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="../events/admin_post_event.php">Event Posting</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../events/admin_delete_event.php">Event Deleting</a></li>
                  <li class="nav-item"> <a class="nav-link" href="../events/admin_approve_event.php">Event Approving</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#organizers" aria-expanded="false" aria-controls="ui-basic">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="categories">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="admin_add_category.php">Add Category</a></li>
                  <li class="nav-item"> <a class="nav-link" href="admin_delete_category.php">Delete Category</a></li>
                </ul>
              </div>
            </li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form action="../../admin_operations/add_advert.php" method="post" enctype="multipart/form-data">
                ...
                <label for="advert_desc">Advert Description:</label><br>
